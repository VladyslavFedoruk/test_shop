! function (e) {
    ...
    t.MODAL_LABELLEDBY_ATTRIB = "data-modal-dialog-labelledby", t.MODAL_COMPONENT_REF_ATTRIB = "data-modal-component-ref", t.MODAL_SELECTOR = `.${r}`, t.SCRIM = {
    ...
    n.on = function (e, t) {
        ...
        let i = this._events[e].indexOf(t); - 1 !== i && this._events[e].splice(i, 1)
    ...
    const n = s(i(22)).default.browser.safari,
        r = {
            sep: "%s",
            reset: "[0m",
            bold: "[1m",
    ...
    t.EVT_AAP_COLOR_CHANGED = "aap:color-changed", t.EVT_AAP_SIZE_CHANGED = "aap:size-changed", t.EVT_RT_BASE_INDEX_CHANGED = "rt-viewer-base:index-changed", t.EVT_RT_VIEWER_ESCAPE = "rt-viewer:escape", t.EVT_RT_VIEWER_READY = "rt-viewer:ready", t.EVT_RT_VIEWER_TRIGGER_LOAD = "rt-viewer:trigger-load", t.EVT_RT_VIEWER_TRIGGER_DESTROY = "rt-viewer:trigger-destroy", t.EVT_RT_VIEWER_ANIMATION_START = "rt-viewer:animation:start", t.EVT_RT_VIEWER_ANIMATION_UPDATE = "rt-viewer:animation:update", t.EVT_RT_VIEWER_ANIMATION_ENDED = "rt-viewer:animation:ended", t.EVT_RT_VIEWER_AAP_DISABLE = "rt-viewer:aap:disable", t.EVT_RT_VIEWER_AAP_ENABLE = "rt-viewer:aap:enable", t.EVT_RT_VIEWER_AAP_TRIGGER = "rt-viewer:aap:trigger", t.EVT_RT_VIEWER_QL_TRIGGERED = "rt-viewer:ql:triggered", t.RT_VIEWER_FEATURE_DETECT = "enhanced-rt"
}, function (e, t, i) {
    "use strict";
    var s = i(0);
    Object.defineProperty(t, "__esModule", {
    ...
    e.exports = {
        RAFEmitter: i(14),
        ThrottledRAFEmitter: i(237),
        update: i(9),
        external: i(80),
        draw: i(1),
        cancelUpdate: i(81),
        cancelExternal: i(238),
        cancelDraw: i(24),
        RAFExecutor: i(50),
        sharedRAFExecutorInstance: i(49)
    }
}, function (e, t, i) {
    "use strict";
    var s = i(0);
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.AAP_EASE_FUNCTIONS = void 0, t.setDefaultDismissKeyframes = function (e, t, i) {
        e.addKeyframe(t, {
            start: .25,
            end: .5,
    ...
    e.exports = function (e, t) {
        var i;
        return t += "", !!(e = s(e)) && (n(e, t) ? t : (i = a[e].css, "" !== (t = (t = t.replace(h, (function (t) {
            var s, a, h, d;
    ...
    const s = i(73),
        ...
        c = i(180),
        u = {};
    "undefined" != typeof window && (u.update = i(9), u.cancelUpdate = i(81), u.external = i(80), u.draw = i(1));
    let m = null;
    class p extends s {
        constructor() {
        ...
        createScrollGroup(e, t) {
            ...
            let i = new l(e, this);
            return (t = t || {}).name && (i.name = t.name), t.getPosition && t.getMaxPosition && (i.getPosition = t.getPosition, i.createViewableRange = () => ({
                a: 0,
                d: t.getMaxPosition()
            })), i.getPosition = t.getPosition || i.getPosition, i.getPosition = t.getPosition || i.getPosition, this.groups.push(i), this.scrollSystems.push(i), this.trigger(n.EVENTS.ON_GROUP_CREATED, i), i
        }
        removeGroup(e) {
    ...
    class g {
        ...
        parseOptions(e) {
            this.jsonProps = e, e.relativeTo && console.error(`KeyframeError: relativeTo has been removed. Use 'anchors' property instead. Found 'relativeTo':"${e.relativeTo}"`), void 0 === e.end && void 0 === e.duration && (e.end = e.start), "" !== e.anchors && e.anchors ? (this.anchors = [], e.anchors = Array.isArray(e.anchors) ? e.anchors : [e.anchors], e.anchors.forEach(((t, i) => {
                    ...
                    if (1 === i.length && (i[1] = i[0], i[0] = null), void 0 === this.controller.tweenProps[t] || !this.controller._ownerIsElement) {
                        ...
                        if (!h && this.controller._ownerIsElement)
                            if (o || p.includes(t)) {
                                ...
                                a = parseFloat(this.controller.getTargetComputedStyle().getPropertyValue(i)), isNaN(a) && (a = 0), h = new r(a, s.KeyframeDefaults.epsilon, this.snapAtCreation, t, n, l), this.controller.cssAttributes.push(h)
    ...
    e.exports = {
        ...
        mounted() {
            s && (this.analytics.name || (console.warn("No ID attribute found on the Mixin Gallery element - please add an ID", this), this.analytics.name = "null"), this.analytics.observer = new s(this, {
    ...
    e.exports = function (e) {
        return "cssfloat" === e.toLowerCase() ? "float" : (s.test(e) && (e = "-" + e), e.replace(/([A-Z]+)([A-Z][a-z])/g, "$1-$2").replace(/([a-z\d])([A-Z])/g, "$1-$2").toLowerCase())
    }
}, function (e, t, i) {
    "use strict";
    var s = /-([a-z])/g;
    ...
    function r(e, t) {
        if ("function" == typeof e.parseVersion) return e.parseVersion(t); {
            ...
            let r;
            for (let e = 0; e < n; e++)
                if (r = t.match((i = s[e], new RegExp(i + "[a-zA-Z\\s/:]+([0-9_.]+)", "i"))), r && r.length > 1) return r[1].replace(/_/g, ".")
        }
        var i;
        return !1
    }
    ...
    function a(e, t, i) {
        ...
        let n, a;
        for (let o = 0; o < s; o++)
            if ("function" == typeof e[o].test ? !0 === e[o].test(i) && (n = e[o].name) : i.ua.indexOf(e[o].userAgent) > -1 && (n = e[o].name), n) {
                if (t[n] = !0, a = r(e[o], i.ua), "string" == typeof a) {
                    const e = a.split(".");
    ...
    e.exports = function (e) {
        const t = {};
        for (const i in e) t[i] = e[i].reduce((function (e, t) {
            return e[t.name] = !1, e
        }), {
            version: {
                string: "",
    ...
    class s {
        ...
        off(e, t) {
            ...
            const i = this._events[e].indexOf(t); - 1 !== i && this._events[e].splice(i, 1)
        }
        trigger(e, t) {
            if (this.has(e))
                for (let i = this._events[e].length - 1; i >= 0; i--) void 0 !== t ? this._events[e][i](t) : this._events[e][i]()
    ...
    class a extends s {
        ...
        parseOptions(e) {
            ...
            s.prototype.parseOptions.call(this, e), this.animValues[this.friendlyName] = [0, 0], void 0 === this.controller.tweenProps[this.friendlyName] && (this.controller.tweenProps[this.friendlyName] = new r(0, 1, !1, this.friendlyName)), this.keyframeType = n.KeyframeTypes.CSSClass
        }
        updateLocalProgress(e) {
    ...
    e.exports = class extends s {
        ...
        updateBounds() {
            ...
            i - t < a.pageMetrics.windowHeight ? (e.min = this.convertScrollPositionToTValue(t - .5 * a.pageMetrics.windowHeight), e.max = this.convertScrollPositionToTValue(i + .5 * a.pageMetrics.windowHeight)) : (e.min -= .001, e.max += .001), this.boundsMin = e.min, this.boundsMax = e.max, this.timelineUpdateRequired = !0
        }
        createViewableRange() {
    ...
    e.exports = function (e, t) {
        if (n.isFocusableElement(e, t)) o(e, a), e.setAttribute(a, "-1");
            ...
            for (var i = n.getTabbableElements(e, t), r = i.length; r--;) o(i[r], a), i[r].setAttribute(a, "-1");
    ...
    e.exports = class {
        constructor(e) {
            ...
            "function" == typeof t && (t = {
                draw: t
            }), this.ease = a(t.ease), this.update = a(t.update), this.draw = a(t.draw), this.prepare = a(t.prepare), this.finish = a(t.finish), this._duration = 1e3 * e, this._startTime = null, this._isPrepared = !1, this._promise = null, this._isPlaying = !1
        }
        get isReversed() {
        ...
        play() {
            ...
            return this._isPlaying = !0, this._promise || (this._promise = new Promise(((e, t) => {
    ...
    e.exports = function (e, t, i) {
        let s;
        "string" != typeof i && (i = i.toString()), s = e instanceof NodeList ? e : [].concat(e), s.forEach((e => {
            e.setAttribute(t, i)
        }))
    }
}, function (e, t, i) {
    ...
    e.exports = {
        ...
        ariaMap: i(32),
        roleMap: i(88),
        focusableElement: i(116),
        disableTabbable: i(90),
        enableTabbable: i(89),
        hideSiblingElements: i(136),
        showSiblingElements: i(137),
        hide: i(85),
        show: i(86),
        setAttributeForElements: i(91),
        setAttributes: i(329),
        removeAttributes: i(117),
        EventProxy: i(330),
        TabManager: i(33),
        ArrowNavigation: i(121),
        RoamingTabIndex: i(119),
        CircularTab: i(135),
        TextZoom: i(100)
    }
}, function (e, t, i) {
    ...
    class r {
        ...
        parseExpression(e, t) {
            ...
            return this.data.target = e.controller.element, this.data.anchors = e.anchors, this.data.keyframe = e.keyframe, this.group.anim.plugins.parser.reduce(((i, s) => i || s.parseExpression.call(this, e, t)), null) || r._parse(t, this.data)
        }
        parseTimeValue(e, t) {
            if ("number" == typeof t) return t;
        ...
        playToChapter(e) {
            ...
            return this.tween = this.timeGroup.anim.addTween({
                ...
                onDraw: e => {
                    ...
                    this.timeGroup.time(i), e.keyframe.curvedT > .5 && !o && (o = !0, this.currentIndex = t.index, this.currentChapter = t, this.timeGroup.trigger(s.EVENTS.ON_CHAPTER_OCCURRED, {
                        player: this,
                        current: t
                    }))
                },
                onComplete: e => {
                    this.destroyed || (this.timeGroup.time(e.tweenProps.time.current), this.timeGroup.trigger(s.EVENTS.ON_CHAPTER_COMPLETED, {
                        player: this,
                        current: t
    ...
    e.exports = function (e, t) {
        let i;
        i = e instanceof NodeList ? e : [].concat(e), t = Array.isArray(t) ? t : [].concat(t), i.forEach((e => {
            t.forEach((t => {
                e.removeAttribute(t)
            }))
        }))
    ...
    e.exports = {
        ...
        itemsCreated() {
            Array.from(this.el.querySelectorAll(this.model.TabNav.ItemSelector)).forEach(((e, t) => {
                ...
                s || console.error(`MixinGallery '${this.el.id}': Could not match tav/dot nav item with trigger '${i.trigger}', to gallery any item. Double check to make sure the triggers match the item id's.`), i.onSelected = e => {
    ...
    var s = i(90),
        ...
        d = function (e, t) {
            ...
            this.el = e, this._navItems = e.querySelectorAll(this._selector), this._navItems = Array.prototype.slice.call(this._navItems), this._state = i, this._navKeys = {}, this.selectOption = this.selectOption.bind(this), this._handleKeyDown = this._handleKeyDown.bind(this), this._setup()
        };
    d.ONSELECT = "onSelect", d.ONFOCUS = "onFocus";
    var c = d.prototype = Object.create(o);
    c._setup = function () {
        for (var e = [h.ARROW_DOWN, h.ARROW_RIGHT], t = [h.ARROW_UP, h.ARROW_LEFT], i = [h.ENTER, h.SPACEBAR], s = 0; s < e.length; s++) this.addNavkey(e[s], this._arrowDown.bind(this, !0)), this.addNavkey(t[s], this._arrowDown.bind(this, null)), this.addNavkey(i[s], this.selectOption);
        this._setupNavItems()
        ...
        t.preventDefault(), this.previousNavItemIndex = this.focusedNavItemIndex, this.focusedNavItemIndex = this._calculateIndex(e, this.focusedNavItemIndex), this._navItems[this.focusedNavItemIndex].focus(), i || this.trigger(d.ONFOCUS, {
            event: t,
    ...
    const r = {
        AnimLoad: async () => Promise.resolve().then((() => n(i(125)))),
        AnimPlay: async () => Promise.resolve().then((() => n(i(126)))),
        FeatureObserver: async () => Promise.resolve().then((() => n(i(220)))),
        LoadTimeout: async () => Promise.resolve().then((() => n(i(223)))),
        PlayPauseButton: async () => Promise.resolve().then((() => n(i(224)))),
        ViewportSource: async () => Promise.resolve().then((() => n(i(127))))
    };
    t.default = r
}, function (e, t, i) {
    "use strict";
    ...
    class p extends h.default {
        ...
        async load(e) {
            ...
            return e !== this._currentLoadUrl && (this.media.trigger(o.default.MEDIA_LOAD_START), this._currentLoadUrl = e, this._pendingPromise = new Promise(((t, i) => {
    ...
    class h extends r.default {
        _initialize() {
            const e = this.media.el.dataset;
            this._retinaEnabled = (0, a.default)(e, this.options, "retinaEnabled", !0), this._anim = this.options.anim, this._componentEl = this.options.componentEl || this.media.el.closest(l.SELECTOR_COMPONENT_CONTAINER), super._initialize()
        }
        _onBreakpointChange() {
        ...
        _applyFallback() {
            this._componentEl ? this._componentEl.classList.add(l.FALLBACK_CLASSNAME) : o.DevLogger.warn(`ViewportSourceOnce plugin is missing a reference to a containing element: ${this}`), (0, n.update)((() => {
    ...
    class u extends n.default {
        constructor(e) {
            ...
            super(i), t = this, this.elements = {}, this.elements.content = e, this.options = i, this.opened = !1, this.model = Object.assign({}, JSON.parse(JSON.stringify(a.default))), this.templates = {}, d.forEach((e => {
                this[e] = function () {
                    for (var i = arguments.length, s = new Array(i), n = 0; n < i; n++) s[n] = arguments[n];
                    t[`__${e}`] && t[`__${e}`].forEach((e => e.apply(t, s)))
                }
            })), this._bindEvents(), ["beforeCreate", "created", "beforeMount"].forEach((e => this[e](i)))
        }
        appendContent(e, t) {
        ...
        static withMixins() {
            const e = class extends u {},
                t = e.prototype;
            for (var i = arguments.length, s = new Array(i), n = 0; n < i; n++) s[n] = arguments[n];
            return [o.default, ...s, h.default, l.default].forEach((e => {
    ...
    e.exports = {
        mounted() {
            this.el.classList.remove("peeking"), this._items.forEach((e => {
        ...
        animateToItem(e) {
            ...
            this.clip = new s(this.model.Fade.duration, {
                ...
                update: e => {
                    e > .5 && !o && (o = !0, this.currentIndex = a.index, this.trigger(this.model.Events.ITEM_CHANGE_OCCURRED, {
                        gallery: this,
                        current: a
                    })), a.opacity = e
                },
    ...
    e.exports = {
        ...
        animateToItem(e) {
            ...
            void 0 !== s && (this.tween = this.anim.addTween(this.scrollContainer, {
                ...
                onComplete: () => {
                    this.currentIndex = e, this.trigger(this.model.Events.ITEM_CHANGE_COMPLETED, {
                        gallery: this,
                        current: t
                    }), n || (this.scrollContainer.style["scroll-snap-type"] = "x mandatory"), this.scrollContainer.addEventListener("scroll", this.onScroll), this.tween = void 0
                }
            }))
        },
        cacheSizeInfo() {
            ...
            this.contentWidth = parseFloat(e.width), this.contentPadding = parseFloat(e.paddingInlineStart), this.scrollWidth = this.scrollContainer.scrollWidth - this.scrollContainer.clientWidth, this.scrollContainerWidth = this.scrollContainer.offsetWidth, this.itemOffsets = [];
            let t = 0;
    ...
    class l extends n.default {
            ...
            if (this.viewerReady) {
                ...
                this.colorNav.querySelectorAll("input").forEach((e => {
                    ...
                    if (n) {
                        ...
                        })), e.setAttribute("aria-label", s.textContent), i[t.dataset.viewerValue] = s.textContent, e.setAttribute("data-aria-map", JSON.stringify(i))
                    }
                    s.remove()
                }));
                this.sizeNav.querySelectorAll("input").forEach((t => {
                    ...
                    if (n) {
                        ...
                        s.querySelectorAll(".footnote").forEach((e => {
                            const t = e.querySelector("a");
                            e.replaceWith(` ${t.getAttribute("aria-label")}`)
                        })), t.setAttribute("aria-label", s.textContent), i[e.dataset.viewerValue] = s.textContent, t.setAttribute("data-aria-map", JSON.stringify(i))
                    }
                    s.remove()
                }))
            } else {
        ...
        _onDrag(e) {
            ...
            const t = e.touches[0].screenX,
                i = t - this.inputStart;
            this.inputStart = t, this.target += i * this.movementRateMultiplier, this.swipeVelocity = i * this.velocityMultiplier, this.nextIndex = "1" === this.ltr ? this.selectedIndex + 1 : this.selectedIndex - 1, this.prevIndex = "1" === this.ltr ? this.selectedIndex - 1 : this.selectedIndex + 1, o(this.dragDrawId), this.dragDrawId = a((() => {
    ...
    t.main = new class {
        constructor() {
            Object.assign(l.default, p.default), this.bubbleGum = null, this._onAnimReady = this._onAnimReady.bind(this), this._onDomKeyframesCreated = this._onDomKeyframesCreated.bind(this), document.documentElement.style.setProperty("--r-viewport-height", window.innerHeight), this._initialize()
        }
        _initLocalnavFocusManager() {
            const e = document.querySelector(".section-welcome .welcome__lockup"),
                ...
                i = [document.querySelector("#ac-localnav .ac-ln-title a"), document.querySelector("#ac-localnav .ac-ln-action-button a"), document.getElementById("ac-ln-menustate-open"), document.getElementById("ac-ln-menustate-close"), ...t].filter((e => !!e)),
        ...
        _initialize() {
            (0, c.trackPageState)(), this.bubbleGum = new o.default(document.body, {
                anim: r.default
            }), this.bubbleGum.anim.on(r.default.model.EVENTS.ON_DOM_KEYFRAMES_CREATED, this._onDomKeyframesCreated), this.bubbleGum.anim.ready.finally(this._onAnimReady), this.bubbleGum.anim.on(a.default.EVENTS.ON_DOM_GROUPS_CREATED, (() => {
                this._monitorScrollHeight()
            })), n.default.detect(), this._initLocalnavFocusManager()
        }
        _onAnimReady() {
    ...
    class R {
        constructor(e) {
            ...
            for (this.text = e, this.pos = 0, this.char = this.text[this.pos], this.tokens = [];
                (t = this.getNextToken()) && t !== I.EOF;) this.tokens.push(t);
            this.tokens.push(t)
        }
        advance() {
    ...
    class M {
        ...
        factor() {
            if (this.currentToken.type === m) return new w(this.consume(m), this.factor());
            if (this.currentToken.type === p) return new w(this.consume(p), this.factor());
    ...
    class D {
        ...
        CSSValue(e) {
            ...
            return "" === i ? 0 : D.Parse(i).execute(l)
        }
        Num(e) {
            return e.value
        }
    ...
    const s = i(10),
        ...
        u = i(168),
        m = {};
    "undefined" != typeof window && (m.update = i(9), m.external = i(80), m.draw = i(1));
    const {
        transformAttributes: p,
        cssAttributes: f,
        domAttributes: _
    } = i(104), g = i(169), E = i(74), y = i(170), v = Math.PI / 180, b = {
        create: i(173),
        rotateX: i(174),
        rotateY: i(175),
        rotateZ: i(176),
    ...
    e.exports = class extends c {
        ...
        updateCachedValuesFromElement() {
            ...
            })), this.tweenProps.rotation = new n(i.rotation[2], r, a, "rotation"), ["rotationX", "rotationY", "rotationZ"].forEach(((e, t) => {
                this.tweenProps[e] = new n(i.rotation[t], r, a, e)
            })), this.tweenProps.scale = new n(i.scale[0], r, a, "scale"), ["scaleX", "scaleY", "scaleZ"].forEach(((e, t) => {
            ...
            if (0 !== r.length)
                if (this.needsWrite = !0, this._ownerIsElement) m.external((() => {
                    ...
                    for (let e = 0, t = r.length; e < t; ++e) {
                        ...
                        if (i.current = i.target = s, !i.isActive) switch (!0) {
                            case i instanceof g:
                            case i instanceof E:
            ...
            for (let e = 0, t = this.attributes.length; e < t; e++) {
                ...
                if (!(i[0].keyframeType > s.KeyframeTypes.InterpolationForward))
                    for (let e = 0, s = i.length; e < s; e++) {
                        let n = i[e];
                        null === n.jsonProps[t][0] && (0 === e ? n.jsonProps[t][0] = n.animValues[t][0] = this.tweenProps[t].current : n.animValues[t][0] = i[e - 1].animValues[t][1]), null === n.jsonProps[t][1] && (n.animValues[t][1] = e === s - 1 ? this.tweenProps[t].current : i[e + 1].animValues[t][0]), n.snapAtCreation && (n.jsonProps[t][0] = n.animValues[t][0], n.jsonProps[t][1] = n.animValues[t][1])
                    }
            }
        }
        getBounds(e) {
    ...
    function h(e) {
        ...
        i[0] = r(c[0]), c[0] = a(c[0], i[0]), h[0] = o(c[0], c[1]), c[1] = l(c[1], c[0], 1, -h[0]), i[1] = r(c[1]), c[1] = a(c[1], i[1]), h[0] /= i[1], h[1] = o(c[0], c[2]), c[2] = l(c[2], c[0], 1, -h[1]), h[2] = o(c[1], c[2]), c[2] = l(c[2], c[1], 1, -h[2]), i[2] = r(c[2]), c[2] = a(c[2], i[2]), h[1] /= i[2], h[2] /= i[2];
        const u = (m = c[1], p = c[2], [m[1] * p[2] - m[2] * p[1], m[2] * p[0] - m[0] * p[2], m[0] * p[1] - m[1] * p[0]]);
        var m, p;
        if (o(c[0], u) < 0)
            for (let e = 0; e < 3; e++) i[e] *= -1, c[e][0] *= -1, c[e][1] *= -1, c[e][2] *= -1;
        let f;
        return t[0] = .5 * Math.sqrt(Math.max(1 + c[0][0] - c[1][1] - c[2][2], 0)), t[1] = .5 * Math.sqrt(Math.max(1 - c[0][0] + c[1][1] - c[2][2], 0)), t[2] = .5 * Math.sqrt(Math.max(1 - c[0][0] - c[1][1] + c[2][2], 0)), t[3] = .5 * Math.sqrt(Math.max(1 + c[0][0] + c[1][1] + c[2][2], 0)), c[2][1] > c[1][2] && (t[0] = -t[0]), c[0][2] > c[2][0] && (t[1] = -t[1]), c[1][0] > c[0][1] && (t[2] = -t[2]), f = t[0] < .001 && t[0] >= 0 && t[1] < .001 && t[1] >= 0 ? [0, 0, n(180 * Math.atan2(c[0][1], c[0][0]) / Math.PI)] : function (e) {
            const [t, i, r, a] = e, o = t * t, l = i * i, h = r * r, d = t * i + r * a, c = a * a + o + l + h;
            return d > .49999 * c ? [0, 2 * Math.atan2(t, a) * s, 90] : d < -.49999 * c ? [0, -2 * Math.atan2(t, a) * s, -90] : [n(Math.atan2(2 * t * a - 2 * i * r, 1 - 2 * o - 2 * h) * s), n(Math.atan2(2 * i * a - 2 * t * r, 1 - 2 * l - 2 * h) * s), n(Math.asin(2 * t * i + 2 * r * a) * s)]
        }(t), {
            translation: d,
            rotation: f,
            eulerRotation: f,
    ...
    } = i(172), o = /^\s*?M[(-?\d)|\s]/, l = /^(inset|circle|ellipse|polygon|path)\(/, h = e => o.test(e), d = e => l.test(e);
    e.exports = {
        install(e, t) {
    ...
    e.exports = function (e, t, i) {
        var s = i[0],
            n = i[1],
            r = i[2];
        return e[0] = t[0] * s, e[1] = t[1] * s, e[2] = t[2] * s, e[3] = t[3] * s, e[4] = t[4] * n, e[5] = t[5] * n, e[6] = t[6] * n, e[7] = t[7] * n, e[8] = t[8] * r, e[9] = t[9] * r, e[10] = t[10] * r, e[11] = t[11] * r, e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15], e
    }
}, function (e, t, i) {
    "use strict";
    const s = i(79),
    ...
    class l extends s {
        ...
        onPlayTimeUpdate() {
            ...
            if (this._repeats === l.REPEAT_FOREVER || this._repeats > 0) {
                let e = !1;
                !this._isReversed && i > this.boundsMax ? (i -= this.boundsMax, e = !0) : this._isReversed && i < 0 && (i = this.boundsMax + i, e = !0), e && (this._repeats = this._repeats === l.REPEAT_FOREVER ? l.REPEAT_FOREVER : this._repeats - 1)
            }
            this.time(i);
    ...
    e.exports = class extends s {
        ...
        addKeyframe(e, t) {
            ...
            return e._animInfo.group = i, e._animInfo.controller = s, [
                ["onStart", "once"],
                ["onDraw", "on"]
            ].forEach((e => {
                let [i, s] = e;
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.default = t.EVT_SCROLL_HEIGHT_CHANGED = void 0;
    var n = s(i(7));
    ...
    class a extends n.default {
        ...
        get heightEl() {
            if (!this._heightEl) {
                ...
                e.setAttribute("data-scroll-height-monitor", "true"), e.style.cssText = "\n        position: absolute;\n        width: 100%;\n        height: 100%;\n        top: 0;\n        pointer-events: none;\n        z-index: -1;\n        visibility: hidden;\n      ", this._targetEl.appendChild(e), this._heightEl = e
            }
    ...
    var s = i(0),
        ...
        L = s(i(52));
    e.exports = {
        ActionButton: w.default,
        ActionsGallery: S.default,
        AllAccessPassL1: b.default,
        AllAccessPassL2: A.default,
        Accordion: v.default,
        ArLink: u.default,
        Camera: O.default,
        DesignParallax: P.default,
        ...
        TextAnim: I.default,
        Welcome: N.default,
        WelcomeLocalnavTrigger: L.default,
        WillChange: C.default
    }
}, function (e, t, i) {
    "use strict";
    var s = i(0);
    ...
    class o extends r.default {
        ...
        focusOn(e) {
            if (e.hasAttribute(a)) {
                ...
                }), i), "-1" === e.getAttribute("tabindex") && e.blur()
            }
        }
        _isEnabledWhen(e) {
    ...
    class l extends n.default {
        ...
        constructor(e) {
            super(e), this.featureDetect = o, this.enhancedScrollGroup = this.anim.createScrollGroup(this.el), this.enhancedScrollGroup.name = "Highlights - Gallery - Enhanced", "Section - Component - Enhanced" === this.enhancedScrollGroup.name && this.logger.error(`${this.componentName}: rename default scroll group`)
        }
        mounted() {
            this.highlightsGallery = new a.default({
                el: this.el
            })
        }
        onUnenhance() {
    ...
    const s = i(41),
        ...
        _ = {
            beforeCreate() {
                this.sectionEle = this.el.closest("section"), this.model.PrefersReducedMotion = document.documentElement.classList.contains("reduced-motion"), this.model.IsRTL = "rtl" === document.documentElement.getAttribute("dir"), this.model.IsTouch = "ontouchstart" in document.documentElement, this.model.Item.Selector = ".item-container .gallery-item", this.model.Slide.Selector = ".item-container", this.model.SwipeDrag.movementRateMultiplier = 1.2, this.model.SwipeDrag.velocityMultiplier = 4
            },
            mounted() {
                this.isPlaying = !1, this.highlightsContent = this.el, this.tabListWrapper = this.el.querySelector(".tablist-wrapper"), this.playPauseButton = this.el.querySelector(".play-pause-button"), this.currentItems = this.tabListWrapper.querySelectorAll(".current"), this.galleryContainer = this.el.querySelector(".media-gallery"), this.dotnavItems = this.el.querySelectorAll(".dotnav-link"), this._setupEvents = this._setupEvents.bind(this), this._playHighlightsGallery = this._playHighlightsGallery.bind(this), this._pauseHighlightsGallery = this._pauseHighlightsGallery.bind(this), this._resetHighlightsGallery = this._resetHighlightsGallery.bind(this), this.abortPreloadingMedia = this.abortPreloadingMedia.bind(this), this.startPreloadingMedia = this.startPreloadingMedia.bind(this), this._preloadOnKeyframe = this._preloadOnKeyframe.bind(this), this._preloadOnPriorSectionLoaded = this._preloadOnPriorSectionLoaded.bind(this), this._togglePlayPause = this._togglePlayPause.bind(this), this._preloadStrategies = {
                    keyframe: this._preloadOnKeyframe,
                    "prior-section": this._preloadOnPriorSectionLoaded
                }, this.anim.addEvent(this.el, {
                    anchors: ["body"],
                    start: "a0t - 100vh",
                    end: "b",
                    onExit: this.abortPreloadingMedia,
                ...
                }), this.highlightsTimeGroup = this.anim.createTimeGroup(), this._setupEvents()
            },
            _executePreloadStrategy() {
                const e = this.galleryContainer.getAttribute("data-preload-strategy");
                "string" == typeof e && e.split(/,\s*/).forEach((e => {
            ...
            _preloadOnKeyframe() {
                this.anim.addEvent(this.el, {
                    ...
                    event: "preload-kf",
                    onEnter: this.startPreloadingMedia,
                    disabledWhen: ["reduced-motion", "aow"]
                })
            },
            ...
            _setupEvents() {
                const e = 6.15;
                let t = 0;
                this.playPauseButton.addEventListener("click", this._togglePlayPause), this.galleryContainer.addEventListener("click", this._togglePlayPause), this.dotnavItems.forEach(((i, s) => {
                    this.highlightsTimeGroup.addKeyframe(i, {
                        start: t,
                        end: t + e,
                        event: "play-animation"
                    }).controller.on("play-animation:exit", (() => {
                    ...
                    })), t = t + e + .1, i.addEventListener("click", (() => {
                        this.galleryHasEnded && this._pauseHighlightsGallery(), this.galleryHasEnded = !1, this.isTransitioning = !0, this.highlightsTimeGroup.time(6.25 * this.currentIndex), requestAnimationFrame((() => {
                            this.isTransitioning = !1
                        }))
                    }))
                })), this.highlightsTimeGroup.on("complete", (() => {
                    this.isPlaying = !1, this.highlightsContent.classList.add("ended"), this.highlightsContent.classList.remove("playing"), this.highlightsContent.classList.remove("paused"), this._updateAnalytics("Replay"), this.galleryHasEnded = !0
                })), this.onSlideChangeCompleted((e => {
                    "swipe" !== e.type && "keynav" !== e.type || (this.isTransitioning = !0, this.highlightsTimeGroup.time(6.25 * e.entered.index), this.galleryHasEnded && (this.galleryHasEnded = !1, this._pauseHighlightsGallery()), requestAnimationFrame((() => {
                        this.isTransitioning = !1
                    })))
                }));
            ...
            _playHighlightsGallery() {
                this.galleryHasEnded ? (this.galleryHasEnded = !1, this._resetHighlightsGallery()) : this.playCurrentMediaGalleryItem(), this.isPlaying = !0, this.highlightsContent.classList.add("playing"), this.highlightsContent.classList.remove("paused"), this.highlightsContent.classList.remove("ended"), requestAnimationFrame((() => {
                    this._updateAnalytics("Pause")
                })), this.highlightsTimeGroup.play()
            },
            _pauseHighlightsGallery() {
                this.isPlaying = !1, this.highlightsContent.classList.add("paused"), this.highlightsContent.classList.remove("playing"), this.highlightsContent.classList.remove("ended"), requestAnimationFrame((() => {
                    this._updateAnalytics("Play")
                })), this.highlightsTimeGroup.pause(), this.pauseCurrentMediaGalleryItem()
            },
            _togglePlayPause() {
                this.isPlaying ? this._pauseHighlightsGallery() : this._playHighlightsGallery()
            },
            _resetHighlightsGallery() {
                this.highlightsTimeGroup.restart(), this.currentItems.forEach((e => {
                    e.classList.remove("current"), requestAnimationFrame((() => {
    ...
    e.exports = {
        ...
        draw() {
            ...
            i < .1 && (this.position = this.target), this.checkForSlideUpdate(), 1 !== e && (this.slideContainer.style.transition = "transform 0.1s cubic-bezier(0.23, 1, 0.32, 1)", this.slideContainer.style.transform = `translate(${-this.position}px, 0)`, Math.abs(i) > 0 && (o(this.dragDrawId), a((() => this.draw(e))))), this._items.forEach((e => {
        ...
        checkForSlideUpdate(e) {
            ...
            isNaN(t) || (t !== this.currentIndex || e) && (this.currentIndex = t, this.wrapSlideItems(), this.trigger(this.model.Events.ITEM_CHANGE_OCCURRED, {
                gallery: this,
                current: this.currentItem
            }))
        },
        wrapSlideItems() {
            this.clampedIndex || this._items.length < 2 || (this.currentItem.x = this.convertSlideIndexToHorizontalPosition(this.currentIndex), this.currentItem.prev.x = this.convertSlideIndexToHorizontalPosition(this.currentIndex - 1), this.currentItem.next.x = this.convertSlideIndexToHorizontalPosition(this.currentIndex + 1))
        },
        onResizeImmediate() {
            this.clip && (this.clip.destroy(), this.clip = null), this._items.forEach((e => {
                e.measure(), e.x = e.width * e.index * this.sign
        ...
        destroy() {
            this.mountUpdateId && l(this.mountUpdateId), this.mountDrawId && o(this.mountDrawId), this.clip && (this.clip.destroy(), this.clip = null), this._items.forEach((e => {
                e.measure(), e.x = 0, e.zIndex = e === this.currentItem ? 2 : 0
    ...
    e.exports = {
        ...
        _onDrag(e) {
            ...
            let {
                screenX: i,
                screenY: r
            } = t, a = this.swipeDrag.inputStart.x - i, o = this.swipeDrag.inputStart.y - r;
            this.swipeDrag.inputStart = {
                x: i,
                y: r
        ...
        waitingToReachTarget(e) {
            if (Math.abs(this.position - this.target) > .1) return void(this.swipeDrag.waitingToReachTargetDrawId = s((() => this.waitingToReachTarget(e))));
    ...
    e.exports = {
        ...
        animateToItem(e) {
            ...
            t && (t.zIndex = 0), i && (i.zIndex = 1), s.opacity = 1, s.zIndex = 2, document.activeElement.id && 0 === document.activeElement.id.indexOf("media-gallery-item-") && document.activeElement.blur(), this.trigger(this.model.Events.ITEM_CHANGE_INITIATED, {
                gallery: this,
                next: s
            }), this.trigger(this.model.Events.ITEM_CHANGE_OCCURRED, {
                gallery: this,
    ...
    e.exports = {
        ...
        mounted() {
            this.on(this.model.Events.ITEM_CHANGE_COMPLETED, (e => {
                let t = null;
                this.lastInteractionEvent && (this.lastInteractionEvent.type ? t = {
                    keydown: "keynav",
                    touchend: "swipe",
                    mouseup: "swipe",
                    click: "link"
                } [this.lastInteractionEvent.type] : this.lastInteractionEvent.event && (t = this.lastInteractionEvent.event)), t || (t = "unknown");
                let i = null;
                if ("swipe" === t || !e.previous || e.previous && e.previous.index === e.current.index) {
                    const s = "number" == typeof this._actualPreviousItem;
                    s && (i = this._actualPreviousItem < e.current.index ? "+" : "-"), this.trigger(this._actuallyEndedEventName, {
                        type: t,
                        direction: i,
                        entered: this._items[e.current.index],
                        exited: s ? this._items[this._actualPreviousItem] : null
                    }), this._actualPreviousItem = e.current.index
                } else {
                    const s = "number" == typeof this._actualPreviousItem;
                    s && (i = this._actualPreviousItem < e.current.index ? "+" : "-"), this.trigger(this._actuallyBegunEventName, {
                        type: t,
                        direction: i,
                        entering: this._items[e.current.index],
                        exiting: s ? this._items[this._actualPreviousItem] : null
                    })
                }
            }))
        },
    ...
    e.exports = {
        mounted() {
            this._setWingVisibilityStatus(), this._mediaGalleryItems = [], this._items.forEach(((e, t) => {
                const i = e.el,
                    n = i.getAttribute("data-media-handler"),
                    r = i.getAttribute("data-media-argument");
                this._mediaGalleryItems[t] = {
                    index: t,
                    type: n,
                    originalItem: e
                };
        ...
        resetOffScreenItems() {
            ...
            this.galleryHasVisibleWings && (e.push(this.currentIndex + 1, this.currentIndex - 1), e = e.filter((e => e >= 0 && e < this._mediaGalleryItems.length))), this._mediaGalleryItems.forEach((function (t) {
                -1 === e.indexOf(t.index) && t.reset()
            }))
        },
        fallbackToStatic() {
            this._mediaGalleryItems ? this._mediaGalleryItems.forEach((e => {
        ...
        abortPreloadingMedia() {
            this._mediaGalleryItems.filter((e => "video" === e.type)).forEach((e => {
    ...
    const s = i(94);
    e.exports = function (e, t) {
        s.apply(this, arguments), e.figureEl = e.originalItem.el.querySelector(".gallery-figure"), e.animationStartClassname = t, e.play = function () {
            ...
            e.isFallback = !0, e.figureEl.classList.remove(e.animationStartClassname), e.figureEl.classList.remove("animation-play"), e.figureEl.classList.add("animation-pause"), e.figureEl.classList.add(e.animationStartClassname), e.figureEl.classList.add("animation-static-end")
        }
    }
}, function (e, t, i) {
    "use strict";
    ...
    e.exports = function (e, t) {
        s.apply(this, arguments), e.mediaCanPlay = !1, e.isFallback = !1, e.mediaPath = t, e.figureWrapperEle = e.originalItem.el.querySelector(".gallery-figure"), e.staticFallbackEle = e.originalItem.el.querySelector(".positioned-media-element.static"), e.videoElement = e.originalItem.el.querySelector(".positioned-media-element.media"), e.startframeEle = e.originalItem.el.querySelector(".positioned-media-element.startframe"), e.endframeEle = e.originalItem.el.querySelector(".positioned-media-element.endframe"), e.originalClassifications = [{
            ele: e.staticFallbackEle,
            className: e.staticFallbackEle.className
        }, {
            ele: e.videoElement,
            className: e.videoElement.className
        }, {
            ele: e.startframeEle,
            className: e.startframeEle.className
        }, {
            ele: e.endframeEle,
            className: e.endframeEle.className
        ...
        }, e.inlineMediaInstance = new n({
            el: e.videoElement,
            loadCompleteEvent: "canplaythrough"
        }), e.load = async function () {
            return e.isFallback ? Promise.resolve() : (e._loadNextItemDeferred(), new Promise(((t, i) => {
        ...
        }.bind(this), e._loadNextItemDeferred = function () {
            e.preparingNextItem || (e.preparingNextItem = !0, e.videoElement.addEventListener("progress", (t => {
            ...
            if (e.isFallback) t = await Promise.resolve();
                ...
                t = await i.catch(e.showStaticFallback).then((() => {
            ...
            e.isFallback || e.hasPlayed && (e.originalClassifications.forEach((e => {
                e.ele.className = e.className
            })), e.mediaCanPlay && (e.pause(), e.videoElement.currentTime = 0), e.hasPlayed = !1)
        }, e.showStaticFallback = function () {
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        for (const e of i) {
            ...
            for (const e of a)
                ...
                } await Promise.all(o.map((async e => e()))), s.push(new n.default(Object.assign({
                el: e,
    ...
    function r(e, t) {
        ...
        for (var n, r = s.length, a = 0; a < r; a++)
            if ((n = t.match((i = s[a], new RegExp(i + "[a-zA-Z\\s/:]+([0-9_.]+)", "i")))) && n.length > 1) return n[1].replace(/_/g, ".");
        return !1
    }
    ...
    class h extends a.default {
        ...
        _createModal(e, t) {
            ...
            return new(n.default.withMixins(o.AnalyticsScrollDepth, i, o.AnimScrollGroup, o.AriaLabelledby, o.CloseElements, r.Focus, o.GumComponentRefId, r.Keyboard, o.LazyImage, o.ModalId, o.OpenButton, o.OpenCloseAnimation, o.OverwriteModel, o.ScrollBuffer, r.ScrollPosition, o.SosumiLinks))(e, {
                attributes: {},
                btnOpen: t
            })
        }
    ...
    e.exports = {
        ...
        disableKeyToOpen(e) {
            const t = this._enabledKeysToOpen.indexOf(e); - 1 !== t && (s.offUp(e, this.open, this), this._enabledKeysToOpen.splice(t, 1))
        },
        disableKeyToClose(e) {
            const t = this._enabledKeysToClose.indexOf(e); - 1 !== t && (s.offUp(e, this.close, this), this._enabledKeysToClose.splice(t, 1))
        }
    }
}, function (e, t, i) {
    "use strict";
    ...
    function o(e, t) {
        ...
        "string" != typeof e && s.DevLogger.error("Required modal analytics prop3 name not provided"), t || s.DevLogger.error("Required progress markers not provided."), t = parseInt(t), !isNaN(t) && Object.keys(i).includes(t.toString()) || s.DevLogger.error("Invalid progress marker");
        let n = `${t}% Viewed`,
            r = `${e} - ${t}% Viewed`;
    ...
    t.default = {
        ...
        beforeMount() {
            const {
                scrollGroup: e
            } = (0, s.createCustomAnimScrollGroup)(this.anim, this.elements.container, this.friendlyName);
    ...
    t.default = {
        ...
        _setupScrimAnimation() {
            const {
                ...
                scrimBlur: i,
                scrimFill: n
            } = this._openCloseAnimTargetValues, a = n.match(/\d+\.*\d*/g), o = a.slice(0, 3).join(), l = a[3], h = parseFloat(i), d = this._openCloseAnimTimeline, c = d.addKeyframe(this.elements.container, {
                start: 0,
                end: e,
                alpha: [0, l],
                blur: [0, h, "px"],
        ...
        _setupContentEnhancedAnimation() {
            const {
                duration: e,
                ease: t
            } = this._openCloseSharedKfOpts, i = this._openCloseAnimTimeline, s = "100vh", n = i.addKeyframe(this.elements.contentContainer, {
                start: 0,
                end: e,
                opacity: [1, 1],
                y: [s, 0],
    ...
    t.default = {
        beforeCreate() {
            ...
            var a;
            t && (r = `${r} ${a=t,a.split(/\s+|,+/).join(" ")}`), "true" === i && (r = `${r} ${s.SCRIM.BLUR_CLASSNAME}`), this.model.Elements.container.Template = n.ModalContainer, this.model.Elements.container.Attributes.class = r, this.model.Elements.container.Attributes[s.BTN_CLOSE_ATTRIB] = "", this.model.Elements.contentContainer = {
                Selector: "[data-modal-element-overlay]",
                Attributes: {
                    class: "modal-overlay",
    ...
    t.default = {
        ...
        _saveScrollBarWidth() {
            (0, s.update)((() => {
                this._scrollBarWidth = window.innerWidth - document.body.clientWidth + "px", (0, s.draw)((() => {
    ...
    function r(e) {
        ...
        t ? this.once(n.ANIMATION_EVTS.CLOSE_COMPLETE, (() => {
            this.options.btnOpen && this.options.btnOpen.focus(), i.scrollIntoView({
                behavior: s
            })
        })) : i.scrollIntoView({
            behavior: s
    ...
    class _ extends n.default {
        ...
        mounted() {
            this._setupGallery(), this.addKeyframe({
                start: "t - 100vh",
                end: "b + 100vh",
        ...
        _setupGallery() {
            const e = {
                    beforeCreate() {
                        this.model.PrefersReducedMotion = document.documentElement.classList.contains("reduced-motion"), this.model.IsRTL = "rtl" === document.documentElement.getAttribute("dir"), this.model.IsTouch = "ontouchstart" in document.documentElement, this.model.duration = .5, this.model.gum = this.gum, this.model.startIndex = 0
                    },
                    mounted() {
            ...
            var i;
            i = t, ["itemsCreated", "onItemChangeCompleted"].forEach((e => {
    ...
    e.exports = {
        mounted() {
            this.captions = Array.from(this.el.querySelectorAll(".card-caption")), this.captions.length && this.captions.forEach(((e, t) => {
    ...
    e.exports = {
        ...
        animateToItem(e) {
            ...
            const r = () => {
                ...
                a = () => {
                    this.currentIndex = e, n || (this.scrollContainer.style["scroll-snap-type"] = "x mandatory"), this.scrollContainer.addEventListener("scroll", this.onScroll), this.galleryTl && this.galleryTl.remove().then((() => this.galleryTl = null)), this.trigger(this.model.Events.ITEM_CHANGE_COMPLETED, {
                        gallery: this,
                        current: t
                    })
                };
            if (this.model.PrefersReducedMotion) return r(), this.scrollContainer.scrollLeft = s, void a();
            this.galleryTl = this.anim.createTimeGroup(this.itemContainer), this.kf = this.galleryTl.addKeyframe(this.scrollContainer, {
                start: 0,
    ...
    const {
        EVT_UNENHANCE: s
    } = i(6), n = i(6).FEATURE_ENHANCED, r = `no-${n}`;
    e.exports = {
        mounted() {
            this.scrollContainer = this.el.querySelector(".scroll-container"), this.itemContainer = this.el.querySelector(".item-container"), this.paddlenav = this.el.querySelector(".paddlenav"), this.withCaptions = this.el.classList.contains("with-captions"), this.withCaptions && (this.captions = this.el.querySelectorAll(".card-caption")), this.isEnhanced = document.documentElement.classList.contains(n), this.isRTL = "rtl" === document.documentElement.getAttribute("dir"), this.galleryScrollGroup = this.anim.createScrollGroup(this.scrollContainer, {
            ...
            })), this.generateXPositionKeyframes(), this.isEnhanced ? this.generateBuildInKeyframes() : this.generateOpacityScaleKeyframes(), this._onUnenhancePageXp = this._onUnenhancePageXp.bind(this), this.anim.once(s, this._onUnenhancePageXp)
        },
        generateOpacityScaleKeyframes() {
            const e = this._items.length;
            this._items.forEach(((t, i) => {
                i < e - 1 && (0 === i && this.isRTL ? this.galleryScrollGroup.addKeyframe(t.cardEl, {
                    start: "a2l - 50a1w + 50a2w",
                    end: "l - 50a1w + 50w",
                    opacity: [.3, 1],
                    ...
                    opacity: [1, .3],
                    anchors: [this.itemContainer, this.scrollContainer, this._items[i + 1].el]
                }), this.withCaptions && (0 === i && this.isRTL ? this.galleryScrollGroup.addKeyframe(this.captions[i], {
                    start: "a1l - 50a0w + 50a1w - 25a1w",
                    end: "a1l - 50a0w + 50a1w",
                    opacity: [0, 1],
                    anchors: [this.scrollContainer, t.el]
                }) : this.galleryScrollGroup.addKeyframe(this.captions[i], {
                    start: "a1l - 50a0w + 50a1w",
                    end: "a1l - 50a0w + 50a1w + 25a1w",
                    opacity: [1, 0],
                    anchors: [this.scrollContainer, t.el]
                }))), 0 !== i && (this.isRTL && this.galleryScrollGroup.addKeyframe(t.cardEl, {
                    start: "l - 50a1w + 50w",
                    end: "l - 50a1w + w + 50a2w + css(row-gap, a0)",
                    scale: [1, "css(--photos-slide-gallery-scale-start, a0)"],
                    anchors: [this.itemContainer, this.scrollContainer, this._items[i - 1].el],
                    disabledWhen: [r]
                }), i === e - 1 && this.isRTL ? this.galleryScrollGroup.addKeyframe(t.cardEl, {
                    start: "l - 50a1w + 50w",
                    end: "a2l - 50a1w + 50a2w",
                    opacity: [1, .3],
                    anchors: [this.itemContainer, this.scrollContainer, this._items[i - 1].el]
                    ...
                    opacity: [.3, 1],
                    anchors: [this.itemContainer, this.scrollContainer, this._items[i - 1].el]
                }), this.isRTL || this.galleryScrollGroup.addKeyframe(t.cardEl, {
                    start: "l - 50a1w - 50a2w - css(row-gap, a0)",
                    end: "l - 50a1w + 50w",
                    scale: ["css(--photos-slide-gallery-scale-start, a0)", 1],
                    anchors: [this.itemContainer, this.scrollContainer, this._items[i - 1].el],
                    disabledWhen: [r]
                }), this.withCaptions && (i === e - 1 && this.isRTL ? this.galleryScrollGroup.addKeyframe(this.captions[i], {
                    start: "a1l - 50a0w + 50a1w",
                    end: "a1l - 50a0w + 50a1w + 25a1w",
                    opacity: [1, 0],
                    anchors: [this.scrollContainer, t.el]
        ...
        generateXPositionKeyframes() {
            this.anchors = [this.itemContainer, this.scrollContainer], this._items.forEach((e => {
                this.anchors.push(e.cardEl)
            })), this.xPositions = [], this._items.forEach(((e, t) => {
                if (t > 1) {
                    const i = [0];
                    for (let e = t; e > 1; e--) {
                        let s = "((";
                    ...
                    if (this.xPositions.push(i), !this.isRTL)
                        for (let s = t; s > 1; s--) {
                            const n = `a${s+1}l - 50a1w - 50a${s}w - css(row-gap, a0)`,
                                ...
                                o = [i[t - s + 1], i[t - s]];
                            this.galleryScrollGroup.addKeyframe(e.cardEl, {
                                start: n,
                                end: a,
                                x: o,
        ...
        generateBuildInKeyframes() {
            this.buildInTimeline = this.anim.createTimeGroup(this.el), this._items.forEach(((e, t) => {
                ...
                t > this.model.startIndex && (r = `(a${n+1}r - r - (a${n+1}w - w)) ${this.isRTL?"-":"+"} abs(${s}) + 50a${n+1}w * (1 - css(--photos-slide-gallery-scale-start, a${n+2})) - (${this.isRTL?"50w":`w - a${n+1}w`}) * css(--photos-slide-gallery-scale-start, a${n+2})`), this.buildInTimeline.addKeyframe(e.el, {
                    start: 0,
                    end: 1.5,
                    x: [r, 0],
                    easeFunction: "easeOutQuad",
                    anchors: [...this.anchors, this._items[this.model.startIndex].el, this.itemContainer],
                    preserveState: !0
                ...
                anchors: [this.itemContainer],
                preserveState: !0
            }), this.withCaptions && this.buildInTimeline.addKeyframe(this.captions[this.model.startIndex], {
                start: 1.2,
                end: 1.5,
                opacity: [0, 1],
                preserveState: !0
            }), this.buildInTimeline.addKeyframe(this.paddlenav, {
                start: 1.2,
                cssClass: "show",
                preserveState: !0
                ...
                this.isEnhanced && (this.scrollContainer.style["scroll-snap-type"] = "none", this.scrollContainer.style.overflow = "hidden", requestAnimationFrame((() => {
                    this.buildInTimeline.play()
                })))
            }))
        },
        _destroyBuildIn() {
            this.scrollContainer.style["scroll-snap-type"] = "x mandatory", this.scrollContainer.style.overflow = null, !this.isEnhanced && this.buildInTimeline.keyframeControllers && this.buildInTimeline.keyframeControllers.forEach((e => {
                e._activeKeyframes.forEach((e => {
                    e.overwriteProps({
                        preserveState: !1
                    })
                }))
            })), this.buildInTimeline.remove(), this._items.forEach((e => {
    ...
    class a extends n.default {
        ...
        constructor(e) {
            super(e), this._anchorEl = this.el.querySelector('a[rel="ar"]'), this._anchorLabel = this._anchorEl.querySelector("span").textContent.trim(), this._data = this._anchorEl.dataset, this._optionMap = JSON.parse(this._data.urlOptionMap), this._defaultAriaLabel = this._anchorEl.ariaLabel, this._defaultAcaClick = this._data.analyticsClick, this._defaultAcaTitle = this._data.analyticsTitle, this.rtViewerEl = document.querySelector(".rt-viewer"), this.viewerUseStandardGallery = "true" === this.rtViewerEl.dataset.useStandardGallery, this._color = "", this._size = "", this._onAapColorChanged = this._onAapColorChanged.bind(this), this._onAapSizeChanged = this._onAapSizeChanged.bind(this), this._anchorEl.addEventListener("click", (() => {
                this.anim.trigger(r.EVT_RT_VIEWER_QL_TRIGGERED)
            }))
        }
        onUnenhance() {
            this.viewerUseStandardGallery && (this._anchorEl.setAttribute("href", this._data.defaultPath), this._anchorEl.setAttribute("aria-label", this._defaultAriaLabel), this._anchorEl.setAttribute("data-analytics-title", this._defaultAcaTitle), this._anchorEl.setAttribute("data-analytics-click", this._defaultAcaClick), this._removeAAPEvents())
        }
        mounted() {
        ...
        _updateTargetPath() {
            ...
            this._anchorEl.href = `${t}/${i}/${e.model}`, this._anchorEl.setAttribute("aria-label", e.ariaLabel), this._anchorEl.setAttribute("data-analytics-title", e.acaTitle), this._anchorEl.setAttribute("data-analytics-click", e.acaClick)
        }
    }
    t.default = a
}, function (e, t, i) {
    ...
    class l extends n.default {
        ...
        constructor(e) {
            super(e), this.onLoadTimeout = this.onLoadTimeout.bind(this), this.onAapColorChanged = this.onAapColorChanged.bind(this), this.onAapSizeChanged = this.onAapSizeChanged.bind(this), this.onViewerReady = this.onViewerReady.bind(this), this.onViewerTriggerLoad = this.onViewerTriggerLoad.bind(this), this.onViewerTriggerDestroy = this.onViewerTriggerDestroy.bind(this), this.onViewerError = this.onViewerError.bind(this), this.mainElm = document.querySelector("main"), this.el.addEventListener("click", (() => {
                this.hasInteracted = !0
            })), this.isLoading = !1, this.rtvIsReady = !1, this.loaderTimeout = parseInt(this.el.dataset.rtLoaderTimeout, 10) || 3e4, this.anim.on(r.EVT_RT_VIEWER_TRIGGER_LOAD, this.onViewerTriggerLoad), this.anim.on(r.EVT_RT_VIEWER_ESCAPE, this.onViewerError), this.anim.on(r.EVT_RT_VIEWER_READY, this.onViewerReady), this.anim.on(r.EVT_RT_VIEWER_TRIGGER_DESTROY, this.onViewerTriggerDestroy), this.anim.on(r.EVT_RT_VIEWER_QL_TRIGGERED, (() => {
                this.stopLoadTimer()
            })), this.onViewerAnimationStart = this.onViewerAnimationStart.bind(this), this.onViewerAnimationUpdate = this.onViewerAnimationUpdate.bind(this), this.onViewerAnimationEnded = this.onViewerAnimationEnded.bind(this)
        }
        _addAnimationEvents() {
            this.anim.on(r.EVT_RT_VIEWER_ANIMATION_START, this.onViewerAnimationStart), this.anim.on(r.EVT_RT_VIEWER_ANIMATION_UPDATE, this.onViewerAnimationUpdate), this.anim.on(r.EVT_RT_VIEWER_ANIMATION_ENDED, this.onViewerAnimationEnded)
        }
        _removeAnimationEvents() {
            this.anim.off(r.EVT_RT_VIEWER_ANIMATION_START, this.onViewerAnimationStart), this.anim.off(r.EVT_RT_VIEWER_ANIMATION_UPDATE, this.onViewerAnimationUpdate), this.anim.off(r.EVT_RT_VIEWER_ANIMATION_ENDED, this.onViewerAnimationEnded)
        }
        _addAAPEvents() {
        ...
        mounted() {
            ...
            const s = {
                ...
                event: "viewer:exit",
                onEventOnce: () => {
                    this.isLoading && this.anim.trigger(r.EVT_RT_VIEWER_ESCAPE, {
                        causeForBase: "scrolled past"
                    })
                },
                disabledWhen: [`no-${r.RT_VIEWER_FEATURE_DETECT}`]
            };
        ...
        onLoadTimeout() {
            window.location.search.includes("no-timeout") || this.anim.trigger(r.EVT_RT_VIEWER_ESCAPE, {
                causeForBase: "loading timeout"
            })
        }
        onAapColorChanged(e) {
            const {
        ...
        onViewerAnimationEnded(e) {
            "intro" === e.animation && (o.ProductViewerWebGLSingleton.scene.isInteracted || requestAnimationFrame((() => {
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.ProductViewerWebGLSingleton = t.ProductViewerWebGL = void 0;
    var n = s(i(40)),
        r = i(17);
    const a = i(291),
        o = i(22),
    ...
    class d {
        ...
        createElements() {
            if (this.gallery = document.querySelector("[data-rt-viewer-id]"), this.element = this.gallery.querySelector(".product-viewer-canvas"), this.loader = this.gallery.querySelector(".loader"), this.loaderIndicator = this.gallery.querySelector(".loader-progress-indicator"), this.loaderPreview = this.gallery.querySelector(".preview-image"), this.sceneData = this.gallery.dataset || {}, this.DEFAULT_SIZE = this.sceneData.rtDefaultSize || "small", this.DEFAULT_COLOR = this.sceneData.rtDefaultColor || "DarkBlue", !this.sceneData.rtPath) throw Error("data-rt-path is required");
        ...
        onCreate() {
            this.createLotusScript(), this.createLotusInstance(), this.timeout = setTimeout((() => {
                this.createScene()
            }), 400)
        }
        createLoader() {
        ...
        async createLotusInstance() {
            this.isLotusInstanceCreated || (this.isLotusInstanceCreated = !0, await this.lotusScript, this.lotus = window.Lotus.instance(), this.lotus.tasks._frameThreshold = 1, this.lotus.settings.initialize({
                FeatureDetect: a,
                UserAgent: o
            }), this.lotus.settings.gltfTextureTasks = !0, this.lotus.settings.pmremCubeFaceSizeLimit = 256, this.lotus.initialize({
                dependencies: {
                    AnimSystem: n.default
                },
                paths: {
                    assets: `${this.DEFAULT_PATH}`,
                    dependencies: `${this.DEFAULT_PATH}/dependencies`
                },
                scenesClasses: this.scenesClasses,
                scenesData: this.scenesData
            }), this.lotus.addEventListener("error", (() => {
                n.default.trigger(r.EVT_RT_VIEWER_ESCAPE, {
                    failedToLoad: !0,
                    causeForBase: "failed to load"
                })
            })), this.lotus.addEventListener("unsupported", (() => {
                n.default.trigger(r.EVT_RT_VIEWER_ESCAPE, {
                    failedToLoad: !0,
                    causeForBase: "lotus unsupported"
                })
        ...
        async createScene() {
            ...
            this.scene = await this.lotus.createScene({
                element: this.element,
                id: "ProductViewerScene"
            }), this.scene && (e || this.scene.loader.addEventListener("load", this.onProgress), this.scene.frameReady.then((() => {
                this.lotus.tasks.tasks.forEach((e => {
                    this.lotus.tasks.resolve(e)
                })), this.stopLoadTimer && this.stopLoadTimer(), a.touchAvailable() && (this.scene.camera.isMobile = !0), e ? (this.loaderIndicator.style.setProperty("--progress", "0%"), this.gallery.classList.remove(h)) : (this.scene.loader.removeEventListener("load", this.onProgress), this.loaderIndicator.style.setProperty("--progress", "0%")), Object.keys(this.PARTS).forEach((e => {
                    this.scene.state.set("geo" === e ? "sidefire" : e, this.PARTS[e] ? "on" : "off")
                })), n.default.trigger(r.EVT_RT_VIEWER_READY), this.hideLoaderTimeout = setTimeout((() => {
        ...
        onColorChange(e) {
            this.scene.state.set("global", e), setTimeout((() => {
                this.lotus.tasks.tasks.forEach((e => {
                    this.lotus.tasks.resolve(e)
                }))
            }), 800)
    ...
    "use strict";
    e.exports = {
        canvasAvailable: i(292),
        continuousScrollEventsAvailable: i(293),
        cookiesAvailable: i(294),
        cssLinearGradientAvailable: i(295),
        cssPropertyAvailable: i(59),
        cssViewportUnitsAvailable: i(296),
        elementAttributeAvailable: i(297),
        eventTypeAvailable: i(298),
        isDesktop: i(98),
        isHandheld: i(303),
        isRetina: i(304),
        isTablet: i(140),
        localStorageAvailable: i(305),
        mediaElementsAvailable: i(306),
        mediaQueriesAvailable: i(307),
        prefersReducedMotion: i(63),
        sessionStorageAvailable: i(308),
        svgAvailable: i(309),
        threeDTransformsAvailable: i(310),
        touchAvailable: i(20),
        webGLAvailable: i(311)
    }
}, function (e, t, i) {
    "use strict";
    var s = i(5),
    ...
    e.exports = function e(t, i) {
        ...
        if (t in n)
            for (d = 0; d < n[t].length; d++)
                if (l = n[t][d], s(l.toLowerCase(), i)) return h[t] = l;
        for (d = 0; d < a.evt.length; d++)
            if (l = a.evt[d] + t, s(l, i)) return a.reduce(d), h[t] = l;
    ...
    const {
        ...
        CustomScene: d
    } = h, c = "[data-rt-viewer-id]";
    t.default = class extends d {
        async init() {
            h.instance().scripts.initialize({
                ObjectTransform: o.ObjectTransform
            }), super.init(), this.productViewer = window.document.querySelector(c), this.LAYERS = JSON.parse(this.productViewer.dataset.rtLayers), this.ANIMATION = JSON.parse(this.productViewer.dataset.rtAnimation);
            const {
                hint: {
                    interval: e = 1e4
                } = {}
            } = this.ANIMATION;
            this.HINT_INTERVAL = e, this.analyticsObject = this.productViewer.dataset.rtAcaInteraction && JSON.parse(this.productViewer.dataset.rtAcaInteraction), await this.createLayerModel(), await this.createLayerCamera(), this.createElement(), this._setAnimationEventsAndTriggers = this._setAnimationEventsAndTriggers.bind(this), n.default.on(r.EVT_RT_VIEWER_READY, this._setAnimationEventsAndTriggers)
        }
        createElement() {
            this.element = document.querySelector(c)
        }
        async createLayerModel() {
            await this.layersCreated, this.models = {}, this.bboxes = {}, this.bboxesLayers = [], this.modelsPromises = [], Object.keys(this.LAYERS.model).forEach((e => {
                this.models[e] = this.getLayer(this.LAYERS.model[e].layer), this.bboxes[e] = this.getLayer(this.LAYERS.model[e].bboxes[0]), this.modelsPromises.push(this.models[e].ready), this.bboxesLayers.push(...this.LAYERS.model[e].bboxes)
            })), await Promise.all(this.modelsPromises), this.models.large.hide(), this.boundingBoxes = this.getObjects(this.bboxesLayers), this.boundingBoxesUID = this.boundingBoxes.map((e => e.uuid)), this.pointer.onPointerTest = e => {
                const t = (() => {
                    let t = !1;
                    if (null !== e[0])
                        for (const t of e)
                            if (this.boundingBoxesUID.includes(t.object.uuid)) return !0;
                    return t
                })();
        ...
        async createLayerCamera() {
            ...
            this.introCameraLayer = this.getLayer(e.intro), this.mainCameraLayer = this.getLayer(e.main), this.interpolationLayer = this.getLayer(e.interpolation), this.interpolation = this.interpolationLayer.scripts.get("InteractiveCameraInterpolation"), await Promise.all([this.introCameraLayer.ready, this.mainCameraLayer.ready]), this.introCamera = this.introCameraLayer.scripts.get("KeyframeTimelineCamera"), this.mainCamera = this.mainCameraLayer.scripts.get("InteractiveCamera"), this.mainCamera.near = 20, this.introCamera.near = 20
        }
        _setAnimationEventsAndTriggers() {
            ...
            }), this.introCameraWrapper = this.introCameraLayer.element.parent.parent, this._onAnimationStart = this._onAnimationStart.bind(this), this._onAnimationUpdate = this._onAnimationUpdate.bind(this), this._onAnimationEnd = this._onAnimationEnd.bind(this), this.introCamera.addEventListener("animation:start", this._onAnimationStart), this.introCamera.addEventListener("animation:ended", this._onAnimationEnd)
        }
        _onAnimationStart(e) {
        ...
        _onAnimationUpdate(e) {
            ...
            this.mainCamera._theta = t, this.mainCamera._proposedPositionTheta = t, this.mainCamera._closestXAngle = t, this.scrollEnded || 1 === this.animation.progress && (this.scrollEnded = !0, this.introScrollKeyframe && !this.introScrollKeyframe.destroyed && this.introScrollKeyframe.remove(), this.timelineScroll && this.timelineScroll._timeline && this.timelineScroll.destroy(), this.playIntroAnimation())
        }
        _onAnimationEnd(e) {
        ...
        onPointerStart() {
            !this.isInteracted && this.analyticsObject && (0, a.trackCustomEvent)(n.default, this.analyticsObject), this.isInteracted = !0, this.introCamera.removeEventListener("animation:update", this._onAnimationUpdate), n.default.trigger(r.EVT_RT_VIEWER_AAP_ENABLE), this.stopHintTimeout(), this.stopHintAnimation(), this.stopIntroAnimation(), this.scrollEnded || (this.scrollEnded = !0), this.introScrollKeyframe && !this.introScrollKeyframe.destroyed && this.introScrollKeyframe.remove(), this.timelineScroll && this.timelineScroll._timeline && this.timelineScroll.destroy(), this.introTriggerEvent && !this.introTriggerEvent.destroyed && this.introTriggerEvent.remove()
        }
        playIntroAnimation() {
        ...
        startHintTimeout() {
            ...
            this.stopHintTimeout(), this.hintTimeout = setTimeout((() => {
        ...
        createScrollAnimation() {
            if (this.stopHintTimeout(), this.stopHintAnimation(), this.stopIntroAnimation(), this.introCamera.addEventListener("animation:update", this._onAnimationUpdate), this.ANIMATION.scroll) {
                this.scrollEnded = !1, this.animation.progress = 0, this.timelineScroll && this.timelineScroll._timeline && this.timelineScroll.destroy(), this.timelineScroll = this.introCamera.createTimeline("scroll"), this.introScrollKeyframe && !this.introScrollKeyframe.destroyed && this.introScrollKeyframe.remove();
                const e = Object.assign({
                    event: "intro:scroll",
                    start: "a0t - 95vh",
                    end: "a0b - 105vh",
                ...
                this.introScrollKeyframe = n.default.addKeyframe(this.animation, e), this.introScrollKeyframe.controller.on("draw", (() => {
                    this.scrollKeyframeCreated = !0
                }))
            } else this.scrollEnded = !0, this.switchCamera(this.introCamera), this.introTimeline = this.introCamera.createTimeline("intro"), this.introTriggerEvent = n.default.addEvent(this.element, Object.assign(this.ANIMATION.intro || {
                start: "t-50vh"
            }, {
                disabledWhen: ["no-enhanced"],
                onEvent: () => {
                    this.introTriggerEvent.remove(), requestAnimationFrame((() => {
        ...
        onSizeChange(e) {
            this.isSizeAnimating || (this.isSizeAnimating = !0, this.stopHintTimeout(), this.stopHintAnimation(), this.stopIntroAnimation(), this.scrollEnded || (this.scrollEnded = !0), this.introScrollKeyframe && !this.introScrollKeyframe.destroyed && this.introScrollKeyframe.remove(), this.timelineScroll && this.timelineScroll._timeline && this.timelineScroll.destroy(), this.introTriggerEvent && !this.introTriggerEvent.destroyed && this.introTriggerEvent.remove(), n.default.trigger(r.EVT_RT_VIEWER_AAP_DISABLE), requestAnimationFrame((() => {
                this.mainCamera.disable && (this.sizeCameraDisable = !0, this.mainCamera.disable()), this.mainCamera.changeState("default", (() => {
        ...
        checkCameraAngle(e) {
            ...
            Math.abs(this.mainCamera._closestXAngle - i) < 1 && Math.abs(this.mainCamera._closestYAngle - t) < 1 && (cancelAnimationFrame(this.loopRAF), this.transitionSize(), this.state.set("animations", e), this.target = this.models["large" === e ? "small" : "large"], requestAnimationFrame((() => {
                Object.keys(this.models).forEach((e => {
                    this.models[e].show()
                }))
            })), clearTimeout(this.sizeTimeout), this.sizeTimeout = setTimeout((() => {
                this.target.hide(), this.mainCamera.enable && (this.sizeCameraDisable = !1, this.mainCamera.enable()), h.instance().tryRequestAnimationFrame(), n.default.trigger(r.EVT_RT_VIEWER_AAP_ENABLE), this.isSizeAnimating = !1, this.target.element.translateX(100)
    ...
    class o {
        ...
        onLoop() {
            ...
            const t = r.MathUtils.degToRad(this.camera._phi),
                ...
                c = n - s,
                u = .5 * Math.PI + Math.atan2(l, o),
                m = .5 * Math.PI - r.MathUtils.degToRad(20),
                p = e => r.MathUtils.clamp(e, 0, 1),
                f = 1 - p((t - m) / (u - m)),
                _ = 1 - p((t - d) / (m + (d - m) / 2 - d));
            e = a + f * (1 - _) * (m - u), e += (c - a) * _, e += s * Math.pow(Math.cos(i), 9), this.case.rotation.x = e, this.layer.element.position.z = -h * Math.sin(e) * .5 * 100, this.layer.element.position.y = h * (1 - Math.cos(e)) * 100
        }
        destroy() {
            n.destroy(this)
        }
    }
    t.ObjectTransform = o, o.fields = {
        case: {
            defaultValue: "",
            type: "String"
        },
    ...
    t.SizeAnimationCases = (e, t, i, s) => {
        const _ = e.size["travel-distance"],
            ...
            C = e.easing.curve;
        let w = i.large.isVisible;
        switch (t) {
            case "front":
                if (d = [0, 0], u = [0, 0], m = 0, p = 0, w) {
        ...
        }), n.default.addTween(r.position, {
            duration: E,
            easeFunction: C,
            delay: v,
            x: c,
            z: u
        }), n.default.addTween(o.rotation, {
            duration: E,
            easeFunction: C,
            y: [m, 0],
            z: [p, 0]
        }), n.default.addTween(r.rotation, {
            duration: E,
            easeFunction: C,
            y: [0, -m],
            z: [0, -p]
        }), n.default.addTween(l.element.material, {
            duration: b,
            delay: T,
    ...
    "use strict";
    const {
        EVT_AAP_COLOR_CHANGED: s,
        EVT_RT_BASE_INDEX_CHANGED: n,
        RT_VIEWER_FEATURE_DETECT: r
    } = i(17), a = i(41), o = i(45), l = i(141), h = i(93), d = i(54), c = i(316), {
        FEATURE_ENHANCED: u
    } = i(6), m = {
        beforeCreate() {
            this.model.PrefersReducedMotion = document.documentElement.classList.contains("reduced-motion"), this.model.IsRTL = "rtl" === document.documentElement.getAttribute("dir"), this.model.IsTouch = "ontouchstart" in document.documentElement, this.model.Item.Selector = ".item-container .gallery-item", this.model.Slide.Selector = ".item-container", this.model.Slide.duration = 1, this.model.InitialIndexFromHashLink.Enabled = !0, this.model.InitialIndexFromHashLink.ScrollReset = !0, this._onAapColorChanged = this._onAapColorChanged.bind(this)
        },
        mounted() {
        ...
        _onAapColorChanged(e) {
            const {
                index: t,
                lastInteractionEvent: i
            } = e;
            this.lastInteractionEvent = i, this.animateToItem(t)
        }
    }, p = [`no-${u}`, `no-${r}`], f = [u, r], _ = c.combine([{
        mixin: l,
        features: p
    }, {
        features: f
    ...
    e.exports = {
        combine: function (e) {
            const t = "feature_mask_" + Math.random().toString(16).slice(2),
                i = {
                    beforeCreate() {
                        this.onFeatureChange = this.onFeatureChange.bind(this), this.featureObserver = ((e, t) => {
                            let i = e.className;
                        ...
                        })(document.documentElement, this.onFeatureChange), this[t] = n(document.documentElement.classList), r(this, "beforeCreate")
                    },
                    onFeatureChange() {
                        const e = n(document.documentElement.classList);
                        e !== this[t] && (r(this, "destroy"), this[t] = e, s((() => {
            ...
            return e.forEach((function (e) {
                e.mixin || (e.mixin = {}), Object.keys(e.mixin).forEach((e => i[e] = i[e] || function () {
    ...
    class o extends n.default {
        ...
        constructor(e) {
            if (super(e), this.featureDetect = r.RT_VIEWER_FEATURE_DETECT, this.destroyed = !document.documentElement.classList.contains(r.RT_VIEWER_FEATURE_DETECT), this.aapId = this.el.dataset.aapId, !this.aapId) throw Error("No id supplid for AAP control");
            this._canvasContainerEl = this.el.querySelector(".rt-viewer-enhanced-container"), this._aapContainer = document.getElementById(this.aapId), this._aapElements = {
                colornav: [...this._aapContainer.querySelectorAll(".viewer-colornav-value")],
                sizenav: [...this._aapContainer.querySelectorAll(".viewer-sizenav-value")]
            }, this._aapColorNav = this._aapContainer.querySelector(".viewer-colornav-items"), this._aapSizeNav = this._aapContainer.querySelector(".viewer-sizenav-items"), this._aapSizeNavContainer = this._aapContainer.querySelector(".viewer-sizenav"), this._onChangeColor = this._onChangeColor.bind(this), this._onChangeSize = this._onChangeSize.bind(this), this._onAapMounted = this._onAapMounted.bind(this), this._onViewerReady = this._onViewerReady.bind(this), this._onViewerError = this._onViewerError.bind(this), this._onGalleryIndexChanged = this._onGalleryIndexChanged.bind(this), this._onAAPDisabled = this._onAAPDisabled.bind(this), this._onAAPEnable = this._onAAPEnable.bind(this), this.anim.on(`aap-mounted--${this.aapId}`, this._onAapMounted), this.anim.once(r.EVT_RT_VIEWER_READY, this._onViewerReady), this.anim.once(r.EVT_RT_VIEWER_ESCAPE, this._onViewerError), this.anim.on(r.EVT_RT_BASE_INDEX_CHANGED, this._onGalleryIndexChanged), this.anim.on(r.EVT_RT_VIEWER_AAP_DISABLE, this._onAAPDisabled), this.anim.on(r.EVT_RT_VIEWER_AAP_ENABLE, this._onAAPEnable)
        }
        mounted() {
            this._aapElements.colornav.forEach((e => e.addEventListener("change", this._onChangeColor))), this._aapElements.sizenav.forEach((e => e.addEventListener("change", this._onChangeSize))), this.destroyed && (0, a.trackViewerState)()
        }
        onUnenhance() {
            this._softDestroy()
        }
        ...
        _updateCanvasAria() {
            this.destroyed || requestAnimationFrame((() => {
        ...
        _onChangeColor(e) {
            ...
            this._focusWasTriggered || (this._focusWasTriggered = !0, this._focusContainer(e.target)), i || this.logger.warn("RealTimeViewerConnector : `data-viewer-value` attribute is invalid:", e.target), this._updateCanvasAria(), this.anim.trigger(r.EVT_AAP_COLOR_CHANGED, {
                index: t,
                color: i,
        ...
        _onChangeSize(e) {
            const t = this._aapElements.sizenav.indexOf(e.target),
                i = e.target.dataset.viewerValue;
            i || this.logger.warn("RealTimeViewerConnector : `data-viewer-value` attribute is invalid:", e.target), this._updateCanvasAria(), this.anim.trigger(r.EVT_AAP_SIZE_CHANGED, {
                index: t,
                size: i
            })
        }
    ...
    class l extends s {
        constructor(e) {
            ...
            super(e), t = this, this.el = e.el, this.model = Object.assign({
                options: e
            }, JSON.parse(JSON.stringify(n))), this.model.Item.ConstructorFunction = n.Item.ConstructorFunction, this.items = {}, o.forEach((e => {
                this[e] = function () {
                    for (var i = arguments.length, s = new Array(i), n = 0; n < i; n++) s[n] = arguments[n];
                    t[`__${e}`] && t[`__${e}`].forEach((e => e.apply(t, s)))
                }
            })), this.on(n.Events.ITEM_CHANGE_INITIATED, this.onItemChangeInitiated), this.on(n.Events.ITEM_CHANGE_COMPLETED, this.onItemChangeCompleted), ["beforeCreate", "created", "beforeMount", "createItems"].forEach((t => this[t](e)))
        }
    }
    ...
    const s = i(8).EventEmitterMicro,
        n = i(33),
        r = i(99).disableTabbable,
        a = {};
    "undefined" != typeof window && (a.draw = i(1), a.cancelDraw = i(24));
    e.exports = class extends s {
        constructor(e) {
            super(), this.contentHeight = 0, this.trayElHeight = 0, this.index = e.index, this.el = e.el, this.model = e.model, this.applyDraw = this.applyDraw.bind(this), this.childKeys = [], this.parentKey = "", this.setupItemElements(), this.measure(), this.setInitialState()
        }
        setupItemElements() {
            ...
            t && (this.parentKey = t.dataset.accordionItem, this.parentExpanded = t.classList.contains(this.model.Item.ExpandedClassName)), this.childKeys.length ? this.tabbableEls = this.trayEl.querySelectorAll("[data-accordion-trigger]") : this.tabbableEls = n.getTabbableElements(this.trayEl, !1)
        }
        setInitialState() {
            let e = this.model.Item.InitialState;
            this.el.classList.contains(this.model.Item.ExpandedClassName) ? e = this.model.Item.ExpandedClassName : this.el.classList.contains(this.model.Item.CollapsedClassName) && (e = this.model.Item.CollapsedClassName), this.initialState = e, this.state = e, this.isExpanded() ? this.setExpandState() : (this.setCollapseState(), r(this.tabbableEls)), !1 === this.parentExpanded && r(this.tabbableEls)
        }
        setExpandState() {
    ...
    "use strict";
    console.warn('"setAttributes" is deprecated, please use "setAttributeForElements" instead.'), e.exports = i(91)
}, function (e, t, i) {
    "use strict";
    var s = i(92),
        n = 0,
    ...
    l._bindEvents = function () {
        ...
        this._proxies[t] && (this._proxies[t].forEach(function (s) {
            s.call(this, e, t, i)
        }.bind(this)), e.addEventListener(t, i))
    }, l.removeEventListener = function (e, t, i) {
        this._proxies[t] && (this._proxies[t].forEach(function (s) {
            s.call(this, e, t, i, !0)
        }.bind(this)), e.removeEventListener(t, i))
    }, l._clickProxy = function (e, t, i, s) {
        var n = e.getAttribute("role");
        r.indexOf(n) < 0 && a("element's role is not set to any of the following " + r.join(", ")), s ? (e.removeEventListener("keydown", this._handleKeydown), this._removeCallback(e, t, i)) : (e.addEventListener("keydown", this._handleKeydown), this._addCallback(e, t, i))
    }, l._hoverProxy = function (e, t, i, s) {
        s ? (e.removeEventListener("focus", this._handleHover, !0), e.removeEventListener("blur", this._handleHover, !0), i && this._removeCallback(e, t, i)) : (e.addEventListener("focus", this._handleHover, !0), e.addEventListener("blur", this._handleHover, !0), i && this._addCallback(e, t, i))
    ...
    e.exports = {
        createItems() {
            if (this.items.length) this.itemsCreated();
                ...
                0 === Object.keys(this.items).length && (this.items = {}, Array.from(this.el.querySelectorAll(this.model.Item.Selector)).forEach(((e, t) => {
                    const i = this.model,
    ...
    e.exports = {
        ...
        animateItem(e) {
            ...
            t.setTrayElHeight(t.contentHeight, "px"), t.trayEl.style.transitionDuration = `${i}ms`, s && s.isAnimating() && (this.animateHeight.timeoutIDs[s.key] = clearTimeout(this.animateHeight.timeoutIDs[s.key]), this.animateParentItem(t, i)), t.isCollapsing() && requestAnimationFrame((() => {
                t.setTrayElHeight(0)
            }));
    ...
    "use strict";
    const s = i(99).enableTabbable,
        n = i(99).disableTabbable;
    e.exports = {
        onItemChangeInitiated(e) {
            const t = e.item;
            t.isExpandState() ? (t.initiateCollapse(), this.disableNestedTabbable(t)) : (t.initiateExpand(), this.enableNestedTabbable(t)), t.measure(), this.animateItem({
                accordion: this,
                item: t
            })
        },
        ...
        enableNestedTabbable(e) {
            s(e.tabbableEls), e.childKeys.forEach((e => {
    ...
    e.exports = {
        ...
        mounted() {
            this.triggers = this.el.querySelectorAll(this.model.Trigger.Selector), this.triggers.forEach((e => {
    ...
    class c extends r.default {
        ...
        setupEvents() {
            this.anim.once(a.EVT_UNENHANCE, (() => this.destroy())), this.anim.on(`modal-created-${this.el.dataset.modalName}`, (e => {
                this.modal = e, this.isEnhanced() && this.initEnhanced(), this.aaps.forEach((t => {
                    t.modalComponent = e, t.mounted()
                })), this.isEnhanced() && e.elements.container.addEventListener("scroll", (() => {
                    this.scrollGroup.updateTimeline()
                })), e.on("open", (() => {
                    this.isEnhanced() && (this.scrollGroup.forceUpdate(), this.forceResize(), this.aaps.forEach((e => {
                        const t = e.preload;
        ...
        initEnhanced() {
            this.scrollGroup = this.anim.createScrollGroup(this.modal.elements.container, {
                getPosition: () => this.modal.elements.container.scrollTop,
                getMaxPosition: () => this.modal.elements.container.scrollHeight
    ...
    class o extends n.default {
        constructor(e) {
            super(e), this._els = null, this._scrollGroup = null, this.isL2 = this.el.closest(r.MODAL_SELECTOR), this.isL2 ? (this.modal = (0, a.getModalComponentRef)(this.gum, this.el), this._scrollGroup = this.modal.animScrollGroup) : (this._scrollGroup = this.anim.createScrollGroup(this.el), this._scrollGroup.name = "Device Anim Component")
        }
        mounted() {
    ...
    class o extends n.default {
        ...
        mounted() {
            ...
            s.breakpointMask = "S", this._els1.forEach((t => {
                this._scrollGroup.addKeyframe(t, e)
    ...
    "use strict";
    var s = i(0)(i(18));
    const n = i(6).FEATURE_ENHANCED;
    class r extends s.default {
        static IS_SUPPORTED() {
            return document.documentElement.classList.contains(n)
        }
        constructor(e) {
            super(e), this.featureDetect = n, this.isRTL = "rtl" === document.documentElement.getAttribute("dir"), this.enhancedScrollGroup = this.anim.createScrollGroup(this.el), this.enhancedScrollGroup.name = "Action Button - ActionButton - Enhanced", this._els = {
                header: this.el.querySelector(".subsection-header"),
                subheader: this.el.querySelector(".subsection-subhead"),
                pin: this.el.querySelector(".pin"),
                tabnav: this.el.querySelector(".tabnav"),
                stickyContainer: this.el.querySelector(".sticky-container"),
                videoContainer: this.el.querySelector(".inline-media-component-container"),
                videoEl: this.el.querySelector("video"),
                videoWrapper: this.el.querySelector(".video-wrapper"),
                itemContainer: this.el.querySelector(".item-container")
            }, this.onVideoEnded = this.onVideoEnded.bind(this), this.onTimeUpdate = this.onTimeUpdate.bind(this), this.onDurationChange = this.onDurationChange.bind(this), this._els.videoEl.addEventListener("timeupdate", this.onTimeUpdate), this._els.videoEl.addEventListener("durationchange", this.onDurationChange), this._els.videoEl.addEventListener("ended", this.onVideoEnded)
        }
        mounted() {
            this.addKeyframe({
                el: this._els.subheader,
                group: this.enhancedScrollGroup,
                start: "css(--subhead-build-in-trigger)",
                cssClass: "show",
                anchors: [this._els.header, this._els.stickyContainer],
                breakpointMask: "XLM"
            }), this.addKeyframe({
                el: this._els.subheader,
                group: this.enhancedScrollGroup,
                ...
                cssClass: "show",
                toggle: !0,
                anchors: [this._els.header],
                breakpointMask: "S"
            }), this.isRTL || (this.deviceKf = this.addKeyframe({
                el: this._els.videoContainer,
                group: this.enhancedScrollGroup,
                start: "a1t - 30vh",
                end: "css(--action-button-video-trigger)",
                y: [50, 0],
                easeFunction: "easeOutSin",
                anchors: [this._els.header, this._els.stickyContainer],
                breakpointMask: "XLM"
            }), this.headerKf = this.addKeyframe({
                el: this._els.header,
                group: this.enhancedScrollGroup,
                start: "a1t - 15vh",
                end: "css(--action-button-video-trigger)",
                ...
                breakpointMask: "XLM"
            }), this.subheaderKf = this.addKeyframe({
                el: this._els.subheader,
                group: this.enhancedScrollGroup,
                start: "a1t - 15vh",
                end: "css(--action-button-video-trigger)",
        ...
        onDurationChange() {
            this.isRTL || (this._els.videoEl.removeEventListener("durationchange", this.onDurationChange), this.addDiscreteEvent({
                group: this.enhancedScrollGroup,
                start: "css(--action-button-video-trigger)",
                event: "remove-group",
                anchors: [this._els.header, this._els.stickyContainer],
                breakpointMask: "XLM",
                onEventOnce: () => {
                    this.deviceKf.remove(), this.subheaderKf.remove(), this.headerKf.remove(), this._els.stickyContainer.classList.add("sticky-end")
                }
            }))
        }
        onTimeUpdate() {
            ...
            e > t - 2.5 && (this.el.classList.add("show-keyline"), this.addKeyframe({
                start: "t - 100vh",
                end: "b",
                cssClass: "animate-indicator",
                toggle: !0,
                breakpointMask: "S",
                disabledWhen: "no-enhanced"
            }), this._els.videoEl.removeEventListener("timeupdate", this.onTimeUpdate))
        }
        onVideoEnded() {
            this.el.classList.add("video-ended"), this._els.videoEl.removeEventListener("ended", this.onVideoEnded)
        }
        destroy() {
            this._els.videoEl.removeEventListener("timeupdate", this.onTimeUpdate), this._els.videoEl.removeEventListener("durationchange", this.onDurationChange), this._els.videoEl.removeEventListener("ended", this.onVideoEnded), super.destroy()
        }
    }
    e.exports = r
}, function (e, t, i) {
    ...
    class p extends n.default {
        ...
        _setupGallery() {
            const e = {
                    beforeCreate() {
                        this.model.PrefersReducedMotion = document.documentElement.classList.contains("reduced-motion"), this.model.IsRTL = "rtl" === document.documentElement.getAttribute("dir"), this.model.IsTouch = "ontouchstart" in document.documentElement, this.model.Fade.duration = .5, this.model.InitialIndexFromHashLink.Enabled = !0, this.model.TabNav.ContainerSelector = ".tabnav"
                    }
                },
                t = r.withMixins(e, a, o, l, m, h, u, d, c),
                i = this._els.gallery;
            this._gallery = new t({
                el: i
            })
    ...
    e.exports = {
        onItemChangeInitiated(e) {
            const {
                current: t,
                next: i
            } = e.gallery.selections.initiated;
            t && t.deselect(), i.select()
        },
        mounted() {
            this._tabnavEl = document.querySelector(this.model.TabNav.ContainerSelector), this._tabnav = new s(this._tabnavEl), this.tabNav.items.forEach((e => {
                this.getItemForTrigger(e.trigger).on("select", (() => {
                    this._tabnav.centerItem(e.el)
                }))
            }))
        }
    }
    ...
    var s = i(352);
    const n = {
        itemsClassname: "tabnav-items",
        itemClassname: "tabnav-link",
        leftPaddleClassname: "tabnav-paddle-left",
        rightPaddleClassname: "tabnav-paddle-right",
    ...
    e.exports = class {
        ...
        _initializePaddles() {
            ...
            this.el.classList.add("with-paddles"), t.innerHTML = `\n\t\t\t<span class="${this._options.rightPaddleClassname}-icon">${s.right}</span>\n\t\t`, e.innerHTML = `\n\t\t\t<span class="${this._options.leftPaddleClassname}-icon">${s.left}</span>\n\t\t`, this._paddles = {
                start: this._isRightToLeft ? t : e,
                end: this._isRightToLeft ? e : t
            }, this._children = this._wrapper.children, this._childCount = this._wrapper.children.length, this._onScrollClipComplete = this._onScrollClipComplete.bind(this), this._onPaddleStartClick = this._onPaddleStartClick.bind(this), this._paddles.start.addEventListener("click", this._onPaddleStartClick), this._onPaddleEndClick = this._onPaddleEndClick.bind(this), this._paddles.end.addEventListener("click", this._onPaddleEndClick), this._onScroll = this._onScroll.bind(this), this._wrapper.addEventListener("scroll", this._onScroll, {
                passive: !0
            }), this._updateElementMetrics = this._updateElementMetrics.bind(this), window.addEventListener("resize", this._updateElementMetrics), window.addEventListener("orientationchange", this._updateElementMetrics), this._updateElementMetrics()
        }
        ...
        _getPaddleStartScrollDestination() {
            ...
            for (let i = this._childCount - 1; i > 0; i--)
                if (t = this._normalizePosition(r(this._children[i])), t[this._inlineStart] < e) return t[this._inlineEnd] - this._wrapperWidth;
            return 0
        }
        _onPaddleEndClick(e) {
        ...
        _getPaddleEndScrollDestination() {
            ...
            for (let i = 0; i < this._childCount; i++)
                if (t = this._normalizePosition(r(this._children[i])), t[this._inlineEnd] > e) return t[this._inlineStart];
        ...
        _smoothScrollTo(e) {
            if (this._updateElementMetrics(), this._lockPaddles || e === this._scrollStart) return;
            ...
            this._usePaddles && (this._lockPaddles = !0), this._clip = new a(this._options.scrollDuration, i), this._clip.play().then((() => {
                this._destroyCurrentClip(), this._clip = null, this._usePaddles && this._onScrollClipComplete()
            }))
        }
        ...
        _destroyPaddles() {
            this._paddles && (this._wrapper.removeEventListener("scroll", this._onScroll), this._paddles.start.removeEventListener("click", this._onPaddleStartClick), this._paddles.end.removeEventListener("click", this._onPaddleEndClick), this._paddles = null)
        }
        destroy() {
    ...
    e.exports = function (e, t) {
        var i, n, r, a, o, l, h;
        return t ? (n = (i = e.getBoundingClientRect()).top, r = i.left, a = i.width, o = i.height, e.offsetParent && (n -= (l = e.offsetParent.getBoundingClientRect()).top, r -= l.left)) : (h = s(e, t), n = e.offsetTop, r = e.offsetLeft, a = h.width, o = h.height), {
            top: n,
            right: r + a,
            bottom: n + o,
            left: r
    ...
    class r extends s.default {
        ...
        constructor(e) {
            super(e), this.featureDetect = n, this._els = {
                headline: this.el.querySelector("[data-anim-headline]"),
                copy: this.el.querySelector("[data-anim-copy]"),
                image: this.el.querySelector("[data-anim-image]")
            }
        }
        mounted() {
            super.mounted(), this._setupKeyframes()
        }
        _setupKeyframes() {
            this._parallaxKeyframes = [this.addKeyframe({
                el: this._els.image,
                anchors: [this._els.headline, this._els.image],
                start: "a0t - 110vh",
                end: "a0t - 20vh",
                scale: ["2.25", "1"],
                y: ["46a1h", "0px"],
                ...
                el: this._els.headline,
                anchors: [this._els.headline],
                start: "a0t - 90vh",
                end: "a0t - 50vh",
                opacity: ["0", "1"]
            }), this.addKeyframe({
        ...
        onUnenhanceParallax() {
            this._parallaxKeyframe && this._parallaxKeyframe.forEach((e => e.remove()))
        }
    }
    e.exports = r
}, function (e, t, i) {
    ...
    class r extends n.default {
        ...
        constructor(e) {
            super(e), this._lightest = this.el.querySelector("[data-lightest]"), this._durable = this.el.querySelector("[data-durable]"), this._ymove = this.el.querySelector("[data-ymove]"), this._scrollGroup = this.anim.createScrollGroup(this.el), this._scrollGroup.name = "Design Parallax Component"
        }
        mounted() {
            const e = {
                    start: "t-75vh",
            ...
            this._lightest && this._scrollGroup.addKeyframe(this._lightest, e), this._durable && this._scrollGroup.addKeyframe(this._durable, e), this._ymove && this._scrollGroup.addKeyframe(this._ymove, t)
        }
    }
    t.default = r
}, function (e, t, i) {
    ...
    class o extends n.Plugin {
        constructor(e) {
            super(e), this._els = {
                el: e.el,
                startFrame: document.querySelector(".welcome__video-media .start-frame"),
                endFrame: document.querySelector(".welcome__video-media .end-frame")
    ...
    class r extends n.default {
        constructor(e) {
            super(e), this._els = {
                ...
                logo: e.el.querySelector(".welcome__video-headline-logo"),
                lockupCTA: e.el.querySelector(".welcome__lockup-cta"),
                lockupCopy: e.el.querySelectorAll(".welcome__lockup p")
            }, this._hiddenEls = [this._els.tradeInBanner, this._els.logo, this._els.lockupCTA, ...this._els.lockupCopy].filter((e => !!e)), this.scrollGroup = this.anim.createScrollGroup(this.el), this._showAllHiddenElements = this._showAllHiddenElements.bind(this), this._onTabNav = this._onTabNav.bind(this)
        }
        mounted() {
            this._setupLockupTradeInBannerAbortAnimation(), this._setupTabNavHandler(), setTimeout((() => {
